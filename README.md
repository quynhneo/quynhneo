...
- Open-source highlights: 
  ...
  Big texts and graph mining tools: [arxiv-public-datasets](https://github.com/mattbierbaum/arxiv-public-datasets). I used these tools for the two projects above.

  Parallel Image Processing Tools: [PIVlab](https://github.com/Shrediquette/PIVlab). I used these tools during my PhD.
