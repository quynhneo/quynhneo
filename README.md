...
- Open-source highlights: 
  ...
  Image Processing Tools: [PIVlab](https://github.com/Shrediquette/PIVlab). This is the post popular Particle Image Velocimetry MATLAB program, cited in thousands of research articles. I contributed to parallelization and redesigning the command line interface. I am also a maintainer of the project.  
